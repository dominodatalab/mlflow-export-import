...
export_source_tags = "Export source run information (RunInfo, MLflow system tags starting with 'export-samples' and metadata) under the 'mlflow_export_import' tag prefix. See README_individual.md for more details."
